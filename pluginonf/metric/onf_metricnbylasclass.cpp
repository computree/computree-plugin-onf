...
QString ONF_MetricNbyLASClass::getDetailledDescription() const
{
    return tr("Les valeurs suivantes sont calculées :<br>"
              "- N : Nombre total de points<br>"
              "- N_first : Nombre de points First<br>"
              "- N_last : Nombre de points Last<br>"
              "- N_int : Nombre de points Intermediate<br>"
              "- N_only : Nombre de points Only<br>"
              "- N_error : Nombre de points en Erreur (nombre de retours ou numéro de retour aberrant)<br>"
              "- N_Cla00_NeverClassified : Nombre de points classés 0<br>"
              "- N_Cla01_Unclassified : Nombre de points classés 1<br>"
              "- N_Cla02_Ground : Nombre de points classés 2<br>"
              "- N_Cla03_LowVegetation : Nombre de points classés 3<br>"
              "- N_Cla04_MediumVegetation : Nombre de points classés 4<br>"
              "- N_Cla05_HighVegetation : Nombre de points classés 5<br>"
              "- N_Cla06_Building : Nombre de points classés 6<br>"
              "- N_Cla07_LowPointNoise : Nombre de points classés 7<br>"
              "- N_Cla08_ModelKeyPoint : Nombre de points classés 8<br>"
              "- N_Cla09_Water : Nombre de points classés 9<br>"
              "- N_Cla10_Rail : Nombre de points classés 10<br>"
              "- N_Cla11_RoadSurface : Nombre de points classés 11<br>"
              "- N_Cla12_OverlapPoint : Nombre de points classés 12<br>"
              "- N_Cla13_WireGuard : Nombre de points classés 13<br>"
              "- N_Cla14_WireConductor : Nombre de points classés 14<br>"
              "- N_Cla15_TransmissionTower : Nombre de points classés 15<br>"
              "- N_Cla16_WireStructureConnector : Nombre de points classés 16<br>"
              "- N_Cla17_BridgeDeck : Nombre de points classés 17<br>"
              "- N_Cla18_HighNoise : Nombre de points classés 18<br>"
              "- N_Cla19_63_Reserved : Nombre de points classés 19 à 63<br>"
              "- N_Cla64_255_UserDefinable : Nombre de points classés 63 à 255<br>"
              "- ZRange : Zmax - Zmin<br>"
              "- NumberOfLines : Nombre de lignes vols couvrant la placette<br>"
              "- N_bestLine : Nombre de points de la ligne de vols ayant le plus de points<br>"
              "- N_secondLine : Nombre de points de la seconde ligne de vols ayant le plus de points<br>"
