...
#ifndef ONF_STEPDETECTVERTICALALIGNMENTS03_H
#define ONF_STEPDETECTVERTICALALIGNMENTS03_H
...
class ONF_StepDetectVerticalAlignments03: public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    ONF_StepDetectVerticalAlignments03(CT_StepInitializeData &dataInit);
...
private:
    ...
    struct LineData {
        ...
        QList<ONF_StepDetectVerticalAlignments03::LineData*> _neighbors;
        bool                                                 _processed;
        double                                               _distSum;
    ...
    public:
        ...
        AlignmentsDetectorForScene(ONF_StepDetectVerticalAlignments03* step, CT_ResultGroup* res)
        {
            _step = step;
            _res = res;
        }
...
#endif // ONF_STEPDETECTVERTICALALIGNMENTS03_H
