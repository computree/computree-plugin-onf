...
#ifndef ONF_STEPCOMPUTEDTM_H
#define ONF_STEPCOMPUTEDTM_H
...
class ONF_StepComputeDTM : public CT_AbstractStep
{
...
public:
     ...
     */
    ONF_StepComputeDTM(CT_StepInitializeData &dataInit);
