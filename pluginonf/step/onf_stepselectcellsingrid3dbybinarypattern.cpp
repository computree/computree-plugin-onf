...
ONF_StepSelectCellsInGrid3DByBinaryPattern::ONF_StepSelectCellsInGrid3DByBinaryPattern(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
    _inThreshold = 1;
...
QString ONF_StepSelectCellsInGrid3DByBinaryPattern::getStepDetailledDescription() const
{
    return tr("No detailled description for this step");
}

// Step URL
QString ONF_StepSelectCellsInGrid3DByBinaryPattern::getStepURL() const
{
...
// Step copy method
CT_VirtualAbstractStep* ONF_StepSelectCellsInGrid3DByBinaryPattern::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ONF_StepSelectCellsInGrid3DByBinaryPattern(dataInit);
}

//////////////////// PROTECTED METHODS //////////////////

// Creation and affiliation of IN models
void ONF_StepSelectCellsInGrid3DByBinaryPattern::createInResultModelListProtected()
{
...
void ONF_StepSelectCellsInGrid3DByBinaryPattern::createOutResultModelListProtected()
{
...
void ONF_StepSelectCellsInGrid3DByBinaryPattern::createPostConfigurationDialog()
{
