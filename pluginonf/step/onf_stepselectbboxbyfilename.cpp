...
ONF_StepSelectBBoxByFileName::ONF_StepSelectBBoxByFileName(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
}
...
QString ONF_StepSelectBBoxByFileName::getStepDetailledDescription() const
{
    return tr("No detailled description for this step");
}

// Step URL
QString ONF_StepSelectBBoxByFileName::getStepURL() const
{
...
// Step copy method
CT_VirtualAbstractStep* ONF_StepSelectBBoxByFileName::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ONF_StepSelectBBoxByFileName(dataInit);
}
...
void ONF_StepSelectBBoxByFileName::createPostConfigurationDialog()
{
