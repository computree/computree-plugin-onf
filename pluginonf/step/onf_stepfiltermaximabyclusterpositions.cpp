...
ONF_StepFilterMaximaByClusterPositions::ONF_StepFilterMaximaByClusterPositions(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
}
...
QString ONF_StepFilterMaximaByClusterPositions::getStepDetailledDescription() const
{
    return tr("No detailled description for this step");
}

// Step URL
QString ONF_StepFilterMaximaByClusterPositions::getStepURL() const
{
...
// Step copy method
CT_VirtualAbstractStep* ONF_StepFilterMaximaByClusterPositions::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ONF_StepFilterMaximaByClusterPositions(dataInit);
}

//////////////////// PROTECTED METHODS //////////////////

// Creation and affiliation of IN models
void ONF_StepFilterMaximaByClusterPositions::createInResultModelListProtected()
{
...
void ONF_StepFilterMaximaByClusterPositions::createPostConfigurationDialog()
{
