...
/*!
 * \class ONF_StepSetFootCoordinatesVertically
 * \ingroup Steps_OE
 ...
 *
 */
class ONF_StepSetFootCoordinatesVertically : public CT_AbstractStep
{
...
public:
     ...
     */
    ONF_StepSetFootCoordinatesVertically(CT_StepInitializeData &dataInit);
