...
#ifndef ONF_STEPFITCYLINDERONCLUSTER_H
#define ONF_STEPFITCYLINDERONCLUSTER_H
...
public:
     ...
     */
    ONF_StepFitCylinderOnCluster(CT_StepInitializeData &dataInit);
...
#endif // ONF_STEPFITCYLINDERONCLUSTER_H
