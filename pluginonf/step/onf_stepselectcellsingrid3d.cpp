...
#include "onf_stepselectcellsingrid3d.h"
...
ONF_StepSelectCellsInGrid3D::ONF_StepSelectCellsInGrid3D(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
    m_doc = NULL;
    _refGrid = NULL;
    _boolGrid = NULL;
...
// Step description (tooltip of contextual menu)
QString ONF_StepSelectCellsInGrid3D::getStepDetailledDescription() const
{
...
QString ONF_StepSelectCellsInGrid3D::getStepURL() const
{
    return tr("http://rdinnovation.onf.fr/projects/plugin-base/wiki/Fr_action_selectcells");
}

// Step copy method
CT_VirtualAbstractStep* ONF_StepSelectCellsInGrid3D::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ONF_StepSelectCellsInGrid3D(dataInit);
}

//////////////////// PROTECTED METHODS //////////////////

// Creation and affiliation of IN models
void ONF_StepSelectCellsInGrid3D::createInResultModelListProtected()
{
...
void ONF_StepSelectCellsInGrid3D::createOutResultModelListProtected()
{
...
void ONF_StepSelectCellsInGrid3D::createPostConfigurationDialog()
{
    // No parameter dialog for this step
}

void ONF_StepSelectCellsInGrid3D::compute()
{
    m_doc = NULL;
    m_status = 0;
...
void ONF_StepSelectCellsInGrid3D::initManualMode()
{
    if(m_doc == NULL)
    {
        ...
        ONF_ActionSelectCellsInGrid3D *action = new ONF_ActionSelectCellsInGrid3D(_refGrid, _boolGrid);
...
void ONF_StepSelectCellsInGrid3D::useManualMode(bool quit)
{
    if(m_status == 0)
    {
        if(quit)
