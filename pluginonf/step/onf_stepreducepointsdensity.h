...
#ifndef ONF_STEPREDUCEPOINTSDENSITY_H
#define ONF_STEPREDUCEPOINTSDENSITY_H
...
public:
     ...
     */
    ONF_StepReducePointsDensity(CT_StepInitializeData &dataInit);
...
#endif // ONF_STEPREDUCEPOINTSDENSITY_H
