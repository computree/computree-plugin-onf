...
#ifndef ONF_STEPVOXELCLUTERIZATION_H
#define ONF_STEPVOXELCLUTERIZATION_H
...
class ONF_StepVoxelClusterization : public CT_AbstractStep
{
    /** \def    Q_OBJECT :
...
public:
    ...
    */
    ONF_StepVoxelClusterization(CT_StepInitializeData &dataInit);
...
private:
    ...
    CT_AutoRenameModels     m_outClusterGroupModel;     /*!< Unique name of the cluster group model */
    CT_AutoRenameModels     m_outClusterModel;          /*!< Unique name of the cluster (item) model */
...
#endif // ONF_STEPVOXELCLUTERIZATION_H
