...
#include "onf_stepmergeclustersfrompositions.h"
...
ONF_StepMergeClustersFromPositions::ONF_StepMergeClustersFromPositions(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
...
QString ONF_StepMergeClustersFromPositions::getStepDescription() const
{
    return tr("Regroupe des clusters à partir de positions 2D");
}

// Step detailled description
QString ONF_StepMergeClustersFromPositions::getStepDetailledDescription() const
{
...
// Step URL
QString ONF_StepMergeClustersFromPositions::getStepURL() const
{
...
// Step copy method
CT_VirtualAbstractStep* ONF_StepMergeClustersFromPositions::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ONF_StepMergeClustersFromPositions(dataInit);
}

//////////////////// PROTECTED METHODS //////////////////

// Creation and affiliation of IN models
void ONF_StepMergeClustersFromPositions::createInResultModelListProtected()
{
...
//void ONF_StepMergeClustersFromPositions::preProcessCreateOutResultModelListProtected()
//{
...
void ONF_StepMergeClustersFromPositions::createOutResultModelListProtected()
{
...
//    {
//        qFatal("Error while create out model in ONF_StepMergeClustersFromPositions");
//    }
...
void ONF_StepMergeClustersFromPositions::createPostConfigurationDialog()
{
...
void ONF_StepMergeClustersFromPositions::compute()
{
    ...
    QFuture<void> futur = QtConcurrent::map(cloudIndices, ONF_StepMergeClustersFromPositions::addPointsToScenes);
...
void ONF_StepMergeClustersFromPositions::addPointsToScenes(QPair<CT_PointCloudIndexVector*, QList<const CT_PointCluster*>* > &pair)
{
    CT_PointCloudIndexVector* cloudIndexVector = pair.first;
...
void ONF_StepMergeClustersFromPositions::initManualMode()
{
    ...
    m_doc->setCurrentAction(new ONF_ActionModifyClustersGroups(&_positionsData));
...
void ONF_StepMergeClustersFromPositions::useManualMode(bool quit)
{
    if(m_status == 0)
    {
        if(quit)
