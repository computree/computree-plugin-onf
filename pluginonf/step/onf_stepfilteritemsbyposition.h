...
#ifndef ONF_STEPFILTERITEMSBYPOSITION_H
#define ONF_STEPFILTERITEMSBYPOSITION_H
...
public:
     ...
     */
    ONF_StepFilterItemsByPosition(CT_StepInitializeData &dataInit);
...
#endif // ONF_STEPFILTERITEMSBYPOSITION_H
