...
#include "onf_stepextractplotbasedonmnt02.h"
...
#define DEF_SearchOutResult "ores"
#define DEF_SearchOutGroup  "ogrp"
#define DEF_SearchOutScene  "osc"

#define DEF_SearchOutMNTResult       "rmnt"

ONF_StepExtractPlotBasedOnMNT02::ONF_StepExtractPlotBasedOnMNT02(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
    _x   = 0.00;
    _y = 0.00;
    _radiusmin = 0.00;
...
QString ONF_StepExtractPlotBasedOnMNT02::getStepDescription() const
{
    return tr("Extraction d'une' placette // MNT (ancienne version)");
}

QString ONF_StepExtractPlotBasedOnMNT02::getStepDetailledDescription() const
{
...
CT_VirtualAbstractStep* ONF_StepExtractPlotBasedOnMNT02::createNewInstance(CT_StepInitializeData &dataInit)
{
    // cree une copie de cette etape
    return new ONF_StepExtractPlotBasedOnMNT02(dataInit);
}

//////////////////// PROTECTED //////////////////

void ONF_StepExtractPlotBasedOnMNT02::createInResultModelListProtected()
{
...
void ONF_StepExtractPlotBasedOnMNT02::createPostConfigurationDialog()
{
    ...
    configDialog->addDouble(tr("Z minimum :"), "m", -10000, 10000, 2, _zmin);
    configDialog->addDouble(tr("Z maximum :"), "m", -10000, 10000, 2, _zmax);
}

void ONF_StepExtractPlotBasedOnMNT02::createOutResultModelListProtected()
{
    ...
    resultModel->addItemModel(DEF_SearchOutGroup, DEF_SearchOutScene, new CT_Scene(), tr("Scène"));
}

void ONF_StepExtractPlotBasedOnMNT02::compute()
{
    // Récupération des résultats d'entrée
