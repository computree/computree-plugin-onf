...
class ONF_StepDetectVerticalAlignments07: public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    ONF_StepDetectVerticalAlignments07(CT_StepInitializeData &dataInit);
...
protected:
    ...
    struct LineData {
        ...
        QList<ONF_StepDetectVerticalAlignments07::LineData*> _neighbors;
        bool                                                 _processed;
        double                                               _distSum;
    ...
    public:
        ...
        AlignmentsDetectorForScene(ONF_StepDetectVerticalAlignments07* step, CT_ResultGroup* res)
        {
            _step = step;
            _res = res;
        }
        ...
        void createClusterFromCandidateLines(ONF_StepDetectVerticalAlignments07::LineData* candidateLine,
                                             CT_PointCluster* cluster,
