...
ONF_StepSegmentCrownsFromStemClusters::ONF_StepSegmentCrownsFromStemClusters(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
    _distMax = 1.0;
}
...
QString ONF_StepSegmentCrownsFromStemClusters::getStepDetailledDescription() const
{
    return tr("No detailled description for this step");
}

// Step URL
QString ONF_StepSegmentCrownsFromStemClusters::getStepURL() const
{
...
// Step copy method
CT_VirtualAbstractStep* ONF_StepSegmentCrownsFromStemClusters::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ONF_StepSegmentCrownsFromStemClusters(dataInit);
}

//////////////////// PROTECTED METHODS //////////////////

// Creation and affiliation of IN models
void ONF_StepSegmentCrownsFromStemClusters::createInResultModelListProtected()
{
...
void ONF_StepSegmentCrownsFromStemClusters::createPostConfigurationDialog()
{
