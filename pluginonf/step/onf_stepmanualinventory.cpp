...
ONF_StepManualInventory::ONF_StepManualInventory(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
    m_doc = NULL;
    setManual(true);
...
// Step copy method
CT_VirtualAbstractStep* ONF_StepManualInventory::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ONF_StepManualInventory(dataInit);
}

//////////////////// PROTECTED METHODS //////////////////

// Creation and affiliation of IN models
void ONF_StepManualInventory::createInResultModelListProtected()
{
...
void ONF_StepManualInventory::createPostConfigurationDialog()
{
...
void ONF_StepManualInventory::createOutResultModelListProtected()
{
