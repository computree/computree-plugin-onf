...
#include "onf_stepaddaffiliationid.h"
...
#define DEF_SearchInResult      "ONF_StepAffIDResult"
#define DEF_SearchInGroup       "ONF_StepAffIDg"
#define DEF_SearchInItem        "ONF_StepAffIDi"

ONF_StepAddAffiliationID::ONF_StepAddAffiliationID(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
}

QString ONF_StepAddAffiliationID::getStepDescription() const
{
    return tr("Ajouter un ID d'affiliation par groupe");
}
...
CT_VirtualAbstractStep* ONF_StepAddAffiliationID::createNewInstance(CT_StepInitializeData &dataInit)
{
    // cree une copie de cette etape
    return new ONF_StepAddAffiliationID(dataInit);
}

//////////////////// PROTECTED //////////////////

void ONF_StepAddAffiliationID::createInResultModelListProtected()
{
...
void ONF_StepAddAffiliationID::createPostConfigurationDialog()
{
    //CT_StepConfigurableDialog *configDialog = newStandardPostConfigurationDialog();
}

void ONF_StepAddAffiliationID::createOutResultModelListProtected()
{
