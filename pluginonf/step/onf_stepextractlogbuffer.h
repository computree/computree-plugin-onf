...
#ifndef ONF_STEPEXTRACTLOGBUFFER_H
#define ONF_STEPEXTRACTLOGBUFFER_H
...
public:
     ...
     */
    ONF_StepExtractLogBuffer(CT_StepInitializeData &dataInit);
...
#endif // ONF_STEPEXTRACTLOGBUFFER_H
