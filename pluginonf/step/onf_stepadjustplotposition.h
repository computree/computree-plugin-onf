...
#ifndef ONF_STEPADJUSTPLOTPOSITION_H
...
public:
     ...
     */
    ONF_StepAdjustPlotPosition(CT_StepInitializeData &dataInit);

    ~ONF_StepAdjustPlotPosition();
...
#endif // ONF_STEPADJUSTPLOTPOSITION_H
