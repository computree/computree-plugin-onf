...
#ifndef ONF_ACTIONSEGMENTGAPS_H
#define ONF_ACTIONSEGMENTGAPS_H


#include "views/actions/onf_actionsegmentgapsoptions.h"
#include "ct_actions/abstract/ct_abstractactionforgraphicsview.h"
#include "ct_itemdrawable/ct_grid2dxy.h"

#include <QRect>

class ONF_ActionSegmentGaps : public CT_AbstractActionForGraphicsView
{
    Q_OBJECT
public:
    ...
    ONF_ActionSegmentGaps(const CT_Grid2DXY<int>* densityGrid, const CT_Grid2DXY<double>* mnsGrid, CT_Grid2DXY<int>* clustersGrid, bool keepOnlyConvexHull = true);

    ~ONF_ActionSegmentGaps();
    ...
    void drawLimit(ONF_ActionSegmentGapsOptions *option, size_t maxCol, size_t maxRow);
    ...
    void drawPencil(PainterInterface &painter, ONF_ActionSegmentGapsOptions *option, const double &resolution, const double &z_val);
