...
#include "onf_actionsegmentgapsoptions.h"
#include "ui_onf_actionsegmentgapsoptions.h"

#include "actions/onf_actionsegmentgaps.h"

#include <QColorDialog>

ONF_ActionSegmentGapsOptions::ONF_ActionSegmentGapsOptions(const ONF_ActionSegmentGaps *action, float initZvalue) :
    CT_GAbstractActionOptions(action),
    ui(new Ui::ONF_ActionSegmentGapsOptions())
{
    ui->setupUi(this);
...
ONF_ActionSegmentGapsOptions::~ONF_ActionSegmentGapsOptions()
{
    delete ui;
}

float ONF_ActionSegmentGapsOptions::getHeight()
{
    return ui->dsb_height->value();
}

int ONF_ActionSegmentGapsOptions::getActiveCluster()
{
    return ui->sb_activeCluster->value();
}

bool ONF_ActionSegmentGapsOptions::getShowClustersOnly()
{
    return ui->pb_showClusters->isChecked();
}


ONF_ActionSegmentGapsOptions::Mode ONF_ActionSegmentGapsOptions::getMode()
{
    return _mode;
}

ONF_ActionSegmentGapsOptions::DrawingGrid ONF_ActionSegmentGapsOptions::getDrawingGrid()
{
    return _drawingGrid;
}

void ONF_ActionSegmentGapsOptions::setHeight(float h)
{
    ui->dsb_height->setValue(h);
    emit parametersChanged();
}

void ONF_ActionSegmentGapsOptions::setActiveCluster(int cluster)
{
    ui->sb_activeCluster->setValue(cluster);
    emit parametersChanged();
}

void ONF_ActionSegmentGapsOptions::setClusterNumber(int nb)
{
    ui->sb_activeCluster->setMaximum(nb);
    emit parametersChanged();
}

void ONF_ActionSegmentGapsOptions::setMode(Mode mode)
{
    _mode = mode;
...
void ONF_ActionSegmentGapsOptions::setDrawingGrid(DrawingGrid drawingGrid)
{
...
double ONF_ActionSegmentGapsOptions::getHSingleStep()
{
...
int ONF_ActionSegmentGapsOptions::getPencilSize()
{
    return ui->sb_pencilSize->value();
}

bool ONF_ActionSegmentGapsOptions::redForSelection()
{
    return ui->pb_activeClusterColor->isChecked();
}

bool ONF_ActionSegmentGapsOptions::isFillModeFull()
{
    return ui->pb_fillMode->isChecked();
}

void ONF_ActionSegmentGapsOptions::increaseHValue()
{
    ui->dsb_height->setValue(ui->dsb_height->value() + getHSingleStep());
    emit parametersChanged();
}

void ONF_ActionSegmentGapsOptions::decreaseHValue()
{
    ui->dsb_height->setValue(ui->dsb_height->value() - getHSingleStep());
    emit parametersChanged();
}

void ONF_ActionSegmentGapsOptions::increasePencilSizeValue()
{
    ui->sb_pencilSize->setValue(ui->sb_pencilSize->value() + 1);
    emit parametersChanged();
}

void ONF_ActionSegmentGapsOptions::decreasePencilSizeValue()
{
    ui->sb_pencilSize->setValue(ui->sb_pencilSize->value() - 1);
    emit parametersChanged();
}

void ONF_ActionSegmentGapsOptions::setActiveClusterColor(const QColor* color)
{  
    if (redForSelection())
    {
...
void ONF_ActionSegmentGapsOptions::setUndoRedo(bool undo, bool redo)
{
...
void ONF_ActionSegmentGapsOptions::on_rb_clusters_clicked()
{
    setDrawingGrid(CLUSTERS);
}

void ONF_ActionSegmentGapsOptions::on_rb_mns_clicked()
{
    setDrawingGrid(HEIGHT);
}

void ONF_ActionSegmentGapsOptions::on_rb_density_clicked()
{
    setDrawingGrid(DENSITY);
}

void ONF_ActionSegmentGapsOptions::on_sb_activeCluster_valueChanged(int arg1)
{
    Q_UNUSED(arg1)
...
void ONF_ActionSegmentGapsOptions::on_dsb_height_valueChanged(double arg1)
{
    Q_UNUSED(arg1)
    emit parametersChanged();
}
...
void ONF_ActionSegmentGapsOptions::on_sb_pencilSize_valueChanged(int arg1)
{
    Q_UNUSED(arg1)
...
void ONF_ActionSegmentGapsOptions::changeSingleStep(int button)
{
    Q_UNUSED(button);
