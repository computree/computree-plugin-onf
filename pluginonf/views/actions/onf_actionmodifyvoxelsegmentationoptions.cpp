...
bool ONF_ActionModifyVoxelSegmentationOptions::isTMPVisible() const
{
...
void ONF_ActionModifyVoxelSegmentationOptions::on_pb_toTmp_clicked()
{
...
void ONF_ActionModifyVoxelSegmentationOptions::on_cb_tmpVisible_toggled(bool checked)
{
    Q_UNUSED(checked);
    emit visibilityChanged();
}
