...
void ONF_ActionSegmentCrownsOptions::on_pb_pickup_clicked()
{
    setMode(CHOOSECLUSTER);
}

void ONF_ActionSegmentCrownsOptions::on_pb_addCluster_clicked()
{
    setMode(DRAWLIMITS);
    emit askForClusterCreation();
}

void ONF_ActionSegmentCrownsOptions::on_pb_drawLimit_clicked()
{
    setMode(DRAWLIMITS);
}

void ONF_ActionSegmentCrownsOptions::on_pb_fill_clicked()
{
    setMode(FILLAREA);
}

void ONF_ActionSegmentCrownsOptions::on_pb_freemove_clicked()
{
    setMode(FREEMOVE);
}

void ONF_ActionSegmentCrownsOptions::on_pb_centerOnCell_clicked()
{
...
void ONF_ActionSegmentCrownsOptions::on_pb_showClusters_clicked()
{
    emit parametersChanged();
}
...
void ONF_ActionSegmentCrownsOptions::on_pb_activeClusterColor_toggled(bool checked)
{
    emit activeClusterChanged();
    emit parametersChanged();
}
...
void ONF_ActionSegmentCrownsOptions::on_pb_merge_clicked()
{
