...
#ifndef ONF_ACTIONSEGMENTGAPSOPTIONS_H
#define ONF_ACTIONSEGMENTGAPSOPTIONS_H

#include "ct_view/actions/abstract/ct_gabstractactionoptions.h"

class ONF_ActionSegmentGaps;

namespace Ui {
class ONF_ActionSegmentGapsOptions;
}

class ONF_ActionSegmentGapsOptions : public CT_GAbstractActionOptions
{
    Q_OBJECT
...
public:
    ...
    explicit ONF_ActionSegmentGapsOptions(const ONF_ActionSegmentGaps *action, float initZvalue);
    ~ONF_ActionSegmentGapsOptions();
...
private:
    Ui::ONF_ActionSegmentGapsOptions *ui;
...
#endif // ONF_ACTIONSEGMENTGAPSOPTIONS_H
